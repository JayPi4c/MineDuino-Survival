...
public class MineDuinoSurvivalArmorMaterials {

    public static final RegistryEntry<ArmorMaterial> ADIOMANTIUM = registerMaterial("adiomantium",
            ...
            () -> Ingredient.ofItems(MineDuinoSurvivalItems.ADIOMANTIUM_INGOT),
            0.0F,
            0.0F,
    ...
    public static RegistryEntry<ArmorMaterial> registerMaterial(
        ...
        List<ArmorMaterial.Layer> layers = List.of(
                ...
                new ArmorMaterial.Layer(Identifier.of(MineDuinoSurvival.MOD_ID, id), "", dyeable)
        );

        ArmorMaterial material = new ArmorMaterial(defensePoints, enchantability, equipSound, repairIngredientSupplier, layers, toughness, knockbackResistance);
        // Register the material within the ArmorMaterials registry.
        material = Registry.register(Registries.ARMOR_MATERIAL, Identifier.of(MineDuinoSurvival.MOD_ID, id), material);
